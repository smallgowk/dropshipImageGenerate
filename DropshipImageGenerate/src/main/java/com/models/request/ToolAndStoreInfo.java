...
public class ToolAndStoreInfo {
    ...
    public int usingFeatureFromDes;
    ...
    public void updateToolConfig() {
        ...
        this.usingFeatureFromDes = Configs.usingFeatureFromDes;
    ...
    public void updateStoreInfo(AliexStoreInfo aliexStoreInfo) {
        ...
        if (!StringUtil.isNullOrEmpty(aliexStoreInfo.tip)) {
            tipLength = aliexStoreInfo.tip.length();
        }
        if (!StringUtil.isNullOrEmpty(aliexStoreInfo.reasons)) {
            reasonLength = aliexStoreInfo.reasons.length();
        }
        if (!StringUtil.isNullOrEmpty(aliexStoreInfo.description)) {
